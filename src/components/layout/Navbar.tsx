...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="h-20 border-b border-border bg-card/50 backdrop-blur-md sticky top-0 z-40 flex items-center justify-between px-6 md:px-8">
      {/* Left: Greeting */}
      <div className="flex flex-col">
        <h1 className="text-lg md:text-xl font-bold tracking-tight text-foreground">
          Good Morning, {displayName || "Harshdeep"}
        </h1>
        <p className="text-xs text-muted">Your career journey is progressing.</p>
      </div>
